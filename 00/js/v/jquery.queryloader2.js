...
OverlayLoader.prototype.createOverlay = function () {
	...
	this.loadbar = $("<div id='qLbar'></div>").css({
		height: "100%", // this.parent.options.barHeight + "px",
	...
	/* this is my additional spinner dream but it sucks right now
	
	if (this.parent.options.percentage == false) {
		this.percentageContainer = $("<div id='spinner'></div>").css({
			width: "128px",
			height: "128px",
			position: "absolute",
			top: "50%",
...
QueryLoader2.prototype.onLoadComplete = function() {
	...
	if (this.options.completeAnimation == "fade") {

		this.overlayLoader.container[0].parent = this;
		this.overlayLoader.container.fadeOut(555, function () {
			this.parent.destroyContainers();
